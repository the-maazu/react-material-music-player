...
import { PlayArrowRounded as PlayIcon, Menu as ReorderIcon } from "@mui/icons-material/";
        ...
        return (
            ...
            >
                ...
                { commonProps.currentTrackID === item.ID ? 
                    <PlayIcon/> : <Box sx={{width:'24px',height:'24px'}}/>
                }
                ...
                <ReorderIcon item {...dragHandleProps} onClick={(e) => {e.stopPropagation()}}/>
            </Box>
        );
    }
}
